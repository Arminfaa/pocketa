...
export default function SettingsPage() {
  ...
  async function onRestoreFileSelected(file: File | undefined) {
    ...
    modal.confirm({
      ...
      content:
        "همه داده‌های فعلی این حساب پاک می‌شود و با محتوای فایل جایگزین می‌شود. هم روی همین اکانت کار می‌کند، هم اگر اکانت جدید ساخته باشید. این کار برگشت‌ناپذیر است.",
      okText: "بازیابی کن",
      okType: "danger",
      cancelText: "انصراف",
      centered: true,
      ...
      {!user ? (
        ...
        <>
          ...
          <SectionCard
            ...
            description="کل داده‌ها را روی دستگاه ذخیره کنید و هر وقت لازم شد روی همین اکانت یا اکانت جدید بازیابی کنید."
          >
            <input
              ref={restoreInputRef}
              type="file"
            ...
            <Space orientation="vertical" size="middle" className="w-full">
              <Text type="secondary" className="text-xs leading-relaxed block">
                رمز و نشست ورود در بکاپ نیست. بازیابی، داده‌های اکانت فعلیِ لاگین‌شده را جایگزین
                می‌کند — چه همان اکانت قبلی باشد، چه اکانت تازه‌ساخته.
              </Text>
