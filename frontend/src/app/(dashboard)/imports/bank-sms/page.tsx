...
const SMS_PLACEHOLDER = `پیامک بانکی پاسارگاد / ملی / فرمت فشرده را اینجا Paste کنید…
      ...
      <PageHeader
        ...
        description={
          isReceiptMode ? (
            ...
            <>
              پیامک بانکی (پاسارگاد / ملی / فشرده) را Paste کنید. مبالغ پیامک معمولاً ریال‌اند و به
              تومان تبدیل می‌شوند؛ بعد از ورود در صفحه نام‌گذاری عنوان بگذارید.
            </>
          )
        }
      />
